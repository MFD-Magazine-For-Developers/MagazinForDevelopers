...
public class ReadingFile { 
	...
	public void readText(String fileInput, JFrame jf) { //txt파일 읽는 메서드입니다.
		// ReadingFile 객체 만들고  ex) ReadingFile rf = new ReadingFile();
		// rf.readText("txt파일 경로", this); 해주시면 텍스트가 창에 나와요. 
		...
		JLabel contentLabel = new JLabel(result);
		contentLabel.setFont(new Font("Gmarket Sans", Font.BOLD, 15));
//		contentLabel.setSize(new Dimension(100,600));
	...
	public void writeTitle(String title, JFrame jf) {
		JLabel sectionTitleLabel = new JLabel("<html>"+ title + "</html>");
		sectionTitleLabel.setFont(new Font("Gmarket Sans", Font.BOLD, 35));
		sectionTitleLabel.setSize(800,80);
		jf.add(sectionTitleLabel);	
	}
